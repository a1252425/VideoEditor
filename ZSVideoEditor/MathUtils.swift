...
func translationMatrix(_ position: vector_float3) -> matrix_float4x4 {
  return matrix_float4x4(vector_float4(1, 0, 0, 0),
                         vector_float4(0, 1, 0, 0),
                         vector_float4(0, 0, 1, 0),
                         vector_float4(position.x, position.y, position.z, 1))
}

func scalingMaxtri(_ scale: Float) -> matrix_float4x4 {
...
func rotationMatrix(_ angle: Float, axis: vector_float3) -> matrix_float4x4 {
...
func modelMatrix() -> matrix_float4x4 {
  ...
  let rotatedY = rotationMatrix(.pi / 4, axis: vector_float3(0, 1, 0))
